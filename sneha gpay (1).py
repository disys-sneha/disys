...
Sneha=gp.Google_pay("sneha10@gmail.com","6383087640","Sneha")
Sneha.open_gpay()
Sneha.email_verification()
Sneha.mobile_verification()
Sneha.name_verification()
Sneha.otp_verification(15698,15698)
Sneha.Bank_verification()
Sneha.PanCard_Verification()
Sneha.set_Pin("5384")
Sneha.Enter_your_Pin(3465,3465)
...
Sneha=Phone_pe("sneha10@gmail.com","6383087640","Sneha")
Sneha.open_phonepe()
Sneha.mobile_verification()
Sneha.name_verification()
Sneha.otp_verification(780965,780965)
Sneha.Bank_verification()
Sneha.PanCard_Verification()
Sneha.set_Pin("087640")
Sneha.Enter_your_Pin(3564,3564)


        
googlepay=[{"name":"JV","gpaynum":7397266887,"type":"personal","transaction":"regular"},                       #DICTIONARY INSIDE LIST
